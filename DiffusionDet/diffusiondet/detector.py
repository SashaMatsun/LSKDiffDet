    ...
    def ddim_sample(self, batched_inputs, backbone_feats, images_whwh, images, clip_denoised=True, do_postprocess=True):
        ...
        if self.use_ensemble and self.sampling_timesteps > 1:
            ...
            if self.use_nms:
                ...
                keep = batched_soft_nms(boxes=box_pred_per_image, scores=scores_per_image, idxs=labels_per_image, gaussian_sigma=0.5, linear_threshold=0.5, prune_threshold=0.001)
